         ...
         <div class="panel panel-primary ">
          <div class="panel-heading clearfix">
            ...
            <div class="pull-right">
                <a href="<?php echo e(route("admin.subadmin")); ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span>Add Subadmin</a>
            </div>
        </div>
...
<script>
    $(function() {
        var table = $('#table1').DataTable({
            ...
            serverSide: true,
            aaSorting : [[0, 'desc']],
            ajax: '<?php echo route('admin.subadmin.data'); ?>',
            columns: [
            { data: 'id', name: 'id' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/neosoft/resources/views/admin/user/list.blade.php ENDPATH**/ ?>