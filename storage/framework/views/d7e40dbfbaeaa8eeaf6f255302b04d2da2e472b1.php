...
<script>
    $(function() {
        var table = $('#table1').DataTable({
            ...
            serverSide: true,
            aaSorting : [[0, 'desc']],
            ajax: '<?php echo route('admin.agent.data'); ?>',
            columns: [
            { data: 'id', name: 'id' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/neosoft/resources/views/admin/ticket/list.blade.php ENDPATH**/ ?>