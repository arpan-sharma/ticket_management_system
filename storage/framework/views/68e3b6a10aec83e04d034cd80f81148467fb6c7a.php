...
<div class="row">
   <div class="col-lg-12">
       ...
       <div class="panel panel-default">
         ...
         <div class="panel-body">
          <div class="col-md-12">
            <form action="<?php echo e(route('admin.post-subadmin')); ?>" class="ajaxformclass" id="admin-subadmin" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="col-sm-12">
  ...
  <div class="form-group">
    ...
    <label class="switch">
        ...
        <span class="switch-label" data-on="Agent"  <?php if($user->user_type == "Subadmin"): ?>  data-off="User" <?php else: ?> data-off="Subadmin" <?php endif; ?>></span>
...
<script type="text/javascript">
    $('.switch-input').on('change', function() {
        <?php if($user->user_type == "Subadmin"): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/neosoft/resources/views/admin/user/create.blade.php ENDPATH**/ ?>