...
<html>
<head>
    <link href="http://localhost/neosoft/public/admin/css/toastr.css" rel="stylesheet"  type="text/css"/>
...
<body>
  <div class="login">
    <h1>Login</h1>
    <form action="<?php echo e(route('admin.signin')); ?>" class="ajaxformclass" id="admin-login" method="post" accept-charset="utf-8">
        <div class="col-sm-12">
...
</html><?php /**PATH /opt/lampp/htdocs/neosoft/resources/views/admin/login.blade.php ENDPATH**/ ?>