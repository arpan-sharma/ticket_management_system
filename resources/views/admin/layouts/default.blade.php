			...
			<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
				<div class="profile-sidebar">
					...
					<div class="profile-usertitle">
						...
						@endphp
						<div class="profile-usertitle-name">Welcome {{ $user->first_name }}</div>
				...
				<ul class="nav menu">
					<li class="@if(Request::is("administrator/dashboard")) active @endif "><a href="{{ route("admin.dashboard") }}"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
					@if($user->user_type == "Admin")
					<li class="@if(Request::is("administrator/sub-admin-or-agent")) active @endif " ><a href="{{ route('admin.subadmin') }}"><em class="fa fa-calendar">&nbsp;</em> Add Users</a></li>
					<li class="@if(Request::is("administrator/all-agent'")) active @endif " ><a href="{{ route("admin.all-agent") }}"><em class="fa fa-users">&nbsp;</em> All Agent</a></li>
					<li class="@if(Request::is("administrator/all-subadmin")) active @endif " ><a href="{{ route("admin.all-subadmin") }}"><em class="fa fa-users">&nbsp;</em> All Subadmin</a></li>
					@elseif($user->user_type == "Subadmin")
					<li class="@if(Request::is("administrator/sub-admin-or-agent")) active @endif " ><a href="{{ route('admin.subadmin') }}"><em class="fa fa-bar-chart">&nbsp;</em> Add User or Agent</a></li>
					<li  ><a href="{{ route("admin.genrate-report") }}"><em class="fa fa-file">&nbsp;</em> Genrate Report </a></li>
					<li class=" @if(Request::is("subadmin/ticket")) active @endif  " ><a href="{{ route("admin.ticket") }}"><em class="fa fa-ticket">&nbsp;</em> Create Ticket </a></li>
					@else
					<li class="@if(Request::is("agent/all-tickets")) active @endif" ><a href="{{ route("admin.all-tickets") }}"><em class="fa fa-bar-chart">&nbsp;</em>  All Tickets </a></li>
					@endif
