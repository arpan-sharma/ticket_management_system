   ...
   <div class="col-lg-12">
       ...
       <div class="panel panel-default">
         ...
         <div class="panel-body">
          <div class="col-md-12">
            <form action="{{ route('admin.ticket-post') }}" class="ajaxformclass" id="admin-subadmin" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="priority">
                    ...
                    <option @if($data->priority == "Emergency") selected="" @endif value="Emergency">Emergency</option>
                </select>
            </div>
            <div class="form-group">
              ...
              <select class="form-control" name="ticket_status">
                ...
                <option @if($data->ticket_status == "Pending") selected="" @endif value="Pending" > Pending </option>
                <option @if($data->ticket_status == "Approved") selected="" @endif value="Approved">Approved</option>
                <option @if($data->ticket_status == "Closed") selected="" @endif value="Closed">Closed</option>
                <option @if($data->ticket_status == "Ready_To_Dispatched") selected="" @endif value="Ready_To_Dispatched">Ready To Dispatched</option>
            </select>
        </div>
